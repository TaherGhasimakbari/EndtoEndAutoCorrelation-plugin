...
#include </home/morsedc/tghasi/EndtoEndAutoCorrelation-plugin/util/DArray.h>          // member template
#include </home/morsedc/tghasi/EndtoEndAutoCorrelation-plugin/util/RingBuffer.h>      // member template parameter

#include </home/morsedc/tghasi/EndtoEndAutoCorrelation-plugin/util/setToZero.h>
#include </home/morsedc/tghasi/EndtoEndAutoCorrelation-plugin/util/product.h>
#include </home/morsedc/tghasi/EndtoEndAutoCorrelation-plugin/util/Array.h>      
   ...
   */
   ...
   void AutoCorrArray<Data, Product>::output(std::ostream& outFile) 
   {
      ...
      for (int i = 0; i < bufferSize; ++i) {
         ...
         outFile << setw(15) << i << setw(15) << autocorr << std::endl;
      }
   }
